...
//     a  b  c  d  e  f  g  h
        ...
        startingBoard.getBoard()[3][4].setPiece(testRook);
...
//     a  b  c  d  e  f  g  h
        ...
        assertEquals(testRook.verifyMove(1, 2),false);
        assertEquals(testRook.verifyMove(4, 3),false);
        assertEquals(testRook.verifyMove(4,5),false);
        assertEquals(testRook.verifyMove(2, 5),false);
